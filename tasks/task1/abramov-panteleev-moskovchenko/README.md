...
По параметру R-squared модель ETC незначительно, но лучше модели ARIMA, с другой стороны по информационному критерию Акаике модель ARIMA значительно лучше модели ETC. => Модель ARIMA лучше.**
