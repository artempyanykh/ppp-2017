...
**Вывод: ARIMA: aic = 255.31 R-squared = 0.008242; ETS: aic = 1359.671 R-squared = 0.06312.
По параметру R-squared модель ETC незначительно, но лучше модели ARIMA, с другой стороны по информационному критерию Акаике модель ARIMA значительно лучше модели ETS. => Модель ARIMA лучше.**
