...
По параметру R-squared модель ETS незначительно, но лучше модели ARIMA, с другой стороны по информационному критерию Акаике модель ARIMA значительно лучше модели ETS. => Модель ARIMA лучше.**
