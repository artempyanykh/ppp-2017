...
unbroken <- c(unbroken[1:3]*(1-risk.harp.1)^(1:3),
              unbroken[4:9]*(1-risk.harp.1)^3*(1-risk.harp.2)^(1:6))
unbroken <- cumsum(unbroken)
