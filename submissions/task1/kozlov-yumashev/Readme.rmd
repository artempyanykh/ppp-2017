...
По графикам вычислим коэффициенты p и q. Рассмотрим график acf и границу значимости. Зафиксируем первый лаг, который попадает в границу значимости и присвоим q значение номера этого лага, уменьшенное на 1. Получим q = 4. Аналогичная процедура проводится для p с графиком pacf. Получим p = 2. Рассмотрим различные модели: Arima(0,1,4), Arima(2,1.0), Arima(2,1,4). 
...
![014](https://cloud.githubusercontent.com/assets/11800617/24836669/66402f86-1d2a-11e7-81eb-acf328411e4c.png)
...
![97](https://cloud.githubusercontent.com/assets/11800617/24836709/c264e094-1d2b-11e7-985a-41dc6848f549.png)

Выбираем модель с меньшим коэффициентом Акаике, то есть Arima(0,1,4)
