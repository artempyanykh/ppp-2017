...
####В силу того, что показатель r2-score для моделей с наилучшим образом подобранными параметрами отрицательный, прогнозирование out-of-bag на 60 периодов вперед с использованием модели ARIMA является плохим решением задачи.
