...
####Согласно результатам теста Акаике наилучшая модель (с наименьшим показателем Акаике): ARIMA(0, 1, 4) with drift.

####В силу того, что показатель r2-score для моделей с наилучшим образом подобранными параметрами отрицательный, прогнозирование out-of-back на 60 периодов вперед с использованием модели ARIMA является плохим решением задачи.
